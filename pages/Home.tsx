...
import { FALLBACK_VIDEOS, TIKTOK_USERNAME, FEATURES } from '../data/constants';
  ...
  return (
    <>
      ...
      {visibility.contact === true && (
        <section id="contact" className="py-24 bg-gradient-to-br from-light via-white to-light w-full">
          <div className="container mx-auto px-4 md:px-6">
            <SectionHeading 
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3">
                        <a href="https://wa.me/966509579993" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#25D366] text-white flex items-center justify-center rounded-lg hover:bg-[#20BA5A] transition-all duration-300 hover:scale-110 shadow-md">
